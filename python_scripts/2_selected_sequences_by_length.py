...
make_histogram_for_distance(data_sequences['length'], path_output+"2_length_histogram.jpg", "Length")
...
data_sequences.to_csv(path_output+"2_selected_sequences.csv", index=False)