...
fig.write_image(path_output+"11_summary_counts_domain_considered_subdomain.svg")

print("Export data")
dataframe.to_csv(path_output+"11_summary_counts_domain_considered_subdomain.csv", index=False)
